...
func (c *Core) CreateTemplate(name string, body []byte, typeName string) (models.Template, error) {
	var newID int
	if err := c.q.CreateTemplate.Get(&newID, name, body, typeName); err != nil {
		return models.Template{}, echo.NewHTTPError(http.StatusInternalServerError,
...
func (c *Core) UpdateTemplate(id int, name string, body []byte, typeName string) (models.Template, error) {
	res, err := c.q.UpdateTemplate.Exec(id, name, body, typeName)
	if err != nil {
		return models.Template{}, echo.NewHTTPError(http.StatusInternalServerError,
